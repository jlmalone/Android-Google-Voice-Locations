...
public class Dialer extends Activity
{
	...
	OnClickListener tapNumber = new OnClickListener()
	{
		...
		public void onClick(View arg0)
		{
			...
			else if (arg0.getId() == CallButton.getId() && !selectedPhone.equals(""))
			{
				...
				final ProgressDialog dialog = ProgressDialog.show(Dialer.this, "", "Initiating Call. Please wait...", true, true);
	...
	public boolean dial(String phoneString, String number)
	{
		...
		{
			//NULL VOICE OBJECT
			Toast.makeText(Dialer.this, "THERE WAS AN ERROR, Call Not Placed " + phoneString + " " + number + " null voice?" + (voice == null),
