 ...
 */
public class BackgroundServiceBak extends Service {
...
// 	public static List<LPEPref> prefList = new ArrayList<LPEPref>();
    ...
    private final GVLServiceInterface.Stub mBinder = new GVLServiceInterface.Stub() {
        ...
        public void reset() throws RemoteException {
            ...
            synchronized(BackgroundServiceBak.this){
                if(geoHandle!=null)
        ...
        public void restart() throws RemoteException {
            BackgroundServiceBak.this.startupStarted = false;
            BackgroundServiceBak.this.getStartupTask().execute();
        }
