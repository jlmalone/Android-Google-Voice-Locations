...
public class LocationMap extends Activity
{
	...
	LatLng point = new LatLng(37.421791,-122.084006);
	//GeoPoint point = new GeoPoint(0, 0);

	LatLng centrepoint = new LatLng(39.421791, -98.084006);
	...
	OnClickListener setClick = new OnClickListener() {
		...
		public void onClick(View v) {
			if(point.latitude!=0 && point.longitude!=0){
				...
				setPrefIntent.putExtra(Settings.LATITUDE_EXTRA, point.latitude);
				setPrefIntent.putExtra(Settings.LONGITUDE_EXTRA, point.longitude);
