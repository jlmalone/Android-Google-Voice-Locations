...
//sdf
	 ...
	 public static double distInMetres(LatLng point1, LatLng point2) {
		    double earthRadius = 6378140;
		    
		    double lat1 =((double)point1.latitude);
		    double lat2 =((double)point2.latitude);
		   double lng1 = ((double)point1.longitude);
		    double lng2 =((double)point2.longitude);
...
//				Integer[] prefs = locationPhonePrefs.get(currentLocationString);
	 ...
	 private void setLocation(int lat , int lon, String loc){
		 ...
		 try{
			...
			status.locationGeoPoint = new LatLng(lat,lon);
...
//				 settings.locationList.clear();
				 ...
				 while(c.moveToNext()){
					 ...
					 LatLng g = new LatLng(c.getInt(1), c.getInt(2));
